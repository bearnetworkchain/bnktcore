...
const (
	...
	Bech32MainPrefix = "bnkt"

	// Purpose is the bnkt purpose as defined in SLIP44 (https://github.com/satoshilabs/slips/blob/master/slip-0044.md)
	Purpose = 44

	// CoinType is the bnkt coin type as defined in SLIP44 (https://github.com/satoshilabs/slips/blob/master/slip-0044.md)
	CoinType = 1230

	// FullFundraiserPath is the parts of the BIP44 HD path that are fixed by
	// what we used during the bnkt fundraiser.
	FullFundraiserPath = "m/44'/1230'/0'/0/0"
