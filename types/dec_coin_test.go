...
func (s *decCoinTestSuite) TestParseDecCoins() {
	testCases := []struct {
		...
		{"5.5bnkt,4stake", sdk.DecCoins{
			sdk.NewDecCoinFromDec("bnkt", sdk.NewDecWithPrec(5500000000000000000, sdk.Precision)),
			sdk.NewDecCoinFromDec("stake", sdk.NewDec(4)),
		}, false},
		{"0.0stake", sdk.DecCoins{}, false}, // remove zero coins
		{"10.0btc,1.0bnkt,20.0btc", nil, true},
		{
			"0.004STAKE",
		...
		},
		{
			"5.04bnkt,0.004stake",
			sdk.DecCoins{
				sdk.NewDecCoinFromDec("bnkt", sdk.NewDecWithPrec(5040000000000000000, sdk.Precision)),
				sdk.NewDecCoinFromDec("stake", sdk.NewDecWithPrec(4000000000000000, sdk.Precision)),
			},
			false,
		},
		{
			"0.0stake,0.004stake,5.04bnkt", // remove zero coins
			sdk.DecCoins{
				sdk.NewDecCoinFromDec("bnkt", sdk.NewDecWithPrec(5040000000000000000, sdk.Precision)),
				sdk.NewDecCoinFromDec("stake", sdk.NewDecWithPrec(4000000000000000, sdk.Precision)),
			},
...
func (s *decCoinTestSuite) TestDecCoinsString() {
	testCases := []struct {
		...
		{sdk.DecCoins{}, ""},
		{
			...
			"5.040000000000000000bnkt,0.004000000000000000stake",
		},
	}
