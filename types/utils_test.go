...
func (s *utilsTestSuite) TestSortJSON() {
	cases := []struct {
		...
		// simple case
		{
			unsortedJSON: `{"cosmos":"foo", "bnkt":"bar",  "tendermint":"foobar"}`,
			want:         `{"bnkt":"bar","cosmos":"foo","tendermint":"foobar"}`, wantErr: false,
		},
		...
		// from the TXSpec:
		{
			unsortedJSON: `{"chain_id":"test-chain-1","sequence":1,"fee_bytes":{"amount":[{"amount":5,"denom":"photon"}],"gas":10000},"msg_bytes":{"inputs":[{"address":"696E707574","coins":[{"amount":10,"denom":"bnkt"}]}],"outputs":[{"address":"6F7574707574","coins":[{"amount":10,"denom":"bnkt"}]}]},"alt_bytes":null}`,
			want:         `{"alt_bytes":null,"chain_id":"test-chain-1","fee_bytes":{"amount":[{"amount":5,"denom":"photon"}],"gas":10000},"msg_bytes":{"inputs":[{"address":"696E707574","coins":[{"amount":10,"denom":"bnkt"}]}],"outputs":[{"address":"6F7574707574","coins":[{"amount":10,"denom":"bnkt"}]}]},"sequence":1}`,
			wantErr:      false,
		},
	}
