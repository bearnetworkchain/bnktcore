...
func (s *coinTestSuite) TestParseCoins() {
	...
	cases := []struct {
		...
		{"10bnkt10", true, sdk.Coins{{"bnkt10", sdk.NewInt(10)}}},
		{"200transfer/channelToA/ubnkt", true, sdk.Coins{{"transfer/channelToA/ubnkt", sdk.NewInt(200)}}},
...
func (s *coinTestSuite) TestNewCoins() {
	tenbnkt := sdk.NewInt64Coin("bnkt", 10)
	...
	tests := []struct {
		...
		{"one coin", []sdk.Coin{tenbnkt}, sdk.Coins{tenbnkt}, false},
		{"sort after create", []sdk.Coin{tenbtc, tenbnkt}, sdk.Coins{tenbnkt, tenbtc}, false},
		{"sort and remove zeroes", []sdk.Coin{zeroeth, tenbtc, tenbnkt}, sdk.Coins{tenbnkt, tenbtc}, false},
		{"panic on dups", []sdk.Coin{tenbnkt, tenbnkt}, sdk.Coins{}, true},
		{"panic on invalid coin", []sdk.Coin{invalidCoin, tenbnkt}, sdk.Coins{}, true},
	}
...
func (s *coinTestSuite) TestCoinsIsAnyGT() {
	twoBnkt := sdk.NewInt64Coin("bnkt", 2)
	fiveBnkt := sdk.NewInt64Coin("bnkt", 5)
	...
	tests := []struct {
		...
		{"{} ≤ 5bnkt", sdk.Coins{}, sdk.Coins{fiveBnkt}, false},
		{"5bnkt > 2bnkt", sdk.Coins{fiveBnkt}, sdk.Coins{twoBnkt}, true},
		{"2bnkt ≤ 5bnkt", sdk.Coins{twoBnkt}, sdk.Coins{fiveBnkt}, false},
		{"2bnkt,6eth > 2btc,5bnkt,3eth", sdk.Coins{twoBnkt, sixEth}, sdk.Coins{twoBtc, fiveBnkt, threeEth}, true},
		{"2btc,2bnkt,3eth ≤ 5bnkt,6eth", sdk.Coins{twoBtc, twoBnkt, threeEth}, sdk.Coins{fiveBnkt, sixEth}, false},
		{"2bnkt,6eth ≤ 2btc,5bnkt", sdk.Coins{twoBnkt, sixEth}, sdk.Coins{twoBtc, fiveBnkt}, false},
	}
...
func (s *coinTestSuite) TestCoinsIsAnyNil() {
	...
	fiveBnkt := sdk.NewInt64Coin("bnkt", 5)
	threeEth := sdk.NewInt64Coin("eth", 3)
	nilBnkt := sdk.Coin{Denom: "bnkt"}

	s.Require().True(sdk.Coins{twoBnkt, fiveBnkt, threeEth, nilBnkt}.IsAnyNil())
	s.Require().True(sdk.Coins{twoBnkt, nilBnkt, fiveBnkt, threeEth}.IsAnyNil())
	s.Require().True(sdk.Coins{nilBnkt, twoBnkt, fiveBnkt, threeEth}.IsAnyNil())
	s.Require().False(sdk.Coins{twoBnkt, fiveBnkt, threeEth}.IsAnyNil())
}
