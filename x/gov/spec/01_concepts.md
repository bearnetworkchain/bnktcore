...
* **Vote:** Once deposit reaches a certain value (`MinDeposit`), proposal is
  confirmed and vote opens. Bonded Bnkt holders can then send `TxGovVote`
...
Cosmos Hub, participants are bonded Bnkt holders. Unbonded Bnkt holders and
...
* _participant_ bonded or unbonded Bnkts to said validator after proposal
  entered voting period.
* _participant_ became validator after proposal entered voting period.

This does not prevent _participant_ to vote with Bnkts bonded to other
validators. For example, if a _participant_ bonded some Bnkts to validator A
before a proposal entered voting period and other Bnkts to validator B after
