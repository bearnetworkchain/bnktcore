...
func TestBalanceValidate(t *testing.T) {
	testCases := []struct {
	...
	}{
		{
			"valid balance",
			bank.Balance{
				Address: "bnkt1yq8lgssgxlx9smjhes6ryjasmqmd3ts2559g0t",
				Coins:   sdk.Coins{sdk.NewInt64Coin("ubnkt", 1)},
			},
			false,
		},
		...
		},
		{
			...
			bank.Balance{
				Address: "bnkt1yq8lgssgxlx9smjhes6ryjasmqmd3ts2559g0t",
				Coins: sdk.Coins{
					sdk.Coin{Denom: "ubnkt", Amount: sdk.NewInt(-1)},
				},
			},
			true,
		},
		{
			...
			bank.Balance{
				Address: "bnkt1yq8lgssgxlx9smjhes6ryjasmqmd3ts2559g0t",
				Coins: sdk.Coins{
					sdk.NewInt64Coin("bnkt", 0),
					sdk.NewInt64Coin("zbnkt", 2),
				},
			},
			true,
		},
		{
			...
			bank.Balance{
				Address: "bnkt1yq8lgssgxlx9smjhes6ryjasmqmd3ts2559g0t",
				Coins: sdk.Coins{
					sdk.NewInt64Coin("bnkt", 2),
					sdk.NewInt64Coin("zbnkt", 2),
					sdk.NewInt64Coin("bbnkt", 12),
				},
			},
			true,
		},
...
func TestBalance_GetAddress(t *testing.T) {
	tests := []struct {
		...
		{"valid address", "bnkt1vy0ga0klndqy92ceqehfkvgmn4t94eteq4hmqv", false},
	}
