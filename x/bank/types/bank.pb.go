...
type DenomUnit struct {
	// denom represents the string name of the given denom unit (e.g ubnkt).
	Denom string `protobuf:"bytes,1,opt,name=denom,proto3" json:"denom,omitempty"`
	// exponent represents power of 10 exponent that one must
	// raise the base_denom to in order to equal the given DenomUnit's denom
	// 1 denom = 10^exponent base_denom
	// (e.g. with a base_denom of ubnkt, one can create a DenomUnit of 'bnkt' with
	// exponent = 6, thus: 1 bnkt = 10^6 ubnkt).
...
type Metadata struct {
	...
	// name defines the name of the token (eg: Cosmos Bnkt)
	//
	// Since: cosmos-sdk 0.43
	Name string `protobuf:"bytes,5,opt,name=name,proto3" json:"name,omitempty"`
	// symbol is the token symbol usually shown on exchanges (eg: BNKT). This can
