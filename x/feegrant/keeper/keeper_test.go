...
func (suite *KeeperTestSuite) SetupTest() {
	...
	suite.bnkt = sdk.NewCoins(sdk.NewCoin("bnkt", sdk.NewInt(555)))
}
...
func (suite *KeeperTestSuite) TestUseGrantedFee() {
	...
	hugeBnkt := sdk.NewCoins(sdk.NewInt64Coin("bnkt", 9999))
	smallBnkt := sdk.NewCoins(sdk.NewInt64Coin("bnkt", 1))
	futureAfterSmall := &feegrant.BasicAllowance{
		SpendLimit: sdk.NewCoins(sdk.NewInt64Coin("bnkt", 554)),
		Expiration: &oneYear,
	}
