...
func AddTxFlagsToCmd(cmd *cobra.Command) {
	...
	cmd.Flags().String(FlagFees, "", "Fees to pay along with transaction; eg: 10ubnkt")
	cmd.Flags().String(FlagGasPrices, "", "Gas prices in decimal format to determine the transaction fee (e.g. 0.1ubnkt)")
	cmd.Flags().String(FlagNode, "tcp://localhost:26657", "<host>:<port> to tendermint rpc interface for this chain")
